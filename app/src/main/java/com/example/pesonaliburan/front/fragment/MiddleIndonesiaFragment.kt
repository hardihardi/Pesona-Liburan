...
import kotlinx.android.synthetic.main.fragment_middle_indonesia.view.*
import kotlinx.android.synthetic.main.fragment_west_indonesia.view.*

/**
 * A simple [Fragment] subclass.
 */
class MiddleIndonesiaFragment : Fragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val view = inflater.inflate(R.layout.fragment_middle_indonesia,container,false)
        view.btn_middleArea.setOnClickListener {
            val toParentActivityFragment = Intent(activity, ParentActivityFragment::class.java)
            toParentActivityFragment.putExtra("areaId",2)
